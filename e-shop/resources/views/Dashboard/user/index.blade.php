    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                                        ...
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left">
                                                    <img width="40" class="rounded-circle" data-toggle="tooltip" title="Image" data-placement="bottom" src="Frontend/img/user/{{$user->avatar ?? 'avatar-default.jpeg'}}" alt="">
                                                </div>
                                            </div>
                ...
                <div class="d-block card-footer p-3">
                    {{ $users->links() }}
                </div>
