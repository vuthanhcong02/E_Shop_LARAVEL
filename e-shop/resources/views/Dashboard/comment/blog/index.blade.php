                    ...
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">{{$comment->blog->title}}</td>
                                <td>{{$comment->messages}}</td>
                                <td class="text-center">
                                    <a href="{{route('blog-comment.show',$comment->id)}}" data-toggle="tooltip" title="Details" data-placement="bottom" class="btn btn-outline-warning border-0 btn-sm">
                                        Details
                                    </a>
                                    <form class="d-inline" action="{{route('blog-comment.destroy',$comment->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
