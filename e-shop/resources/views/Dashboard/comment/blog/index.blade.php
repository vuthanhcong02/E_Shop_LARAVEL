                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('blog.show',$comment->id)}}" data-toggle="tooltip" title="Details" data-placement="bottom" class="btn btn-outline-warning border-0 btn-sm">
                                        Details
                                    </a>
                                    <form class="d-inline" action="{{route('blog.destroy',$comment->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
